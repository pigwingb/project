...
#define AltHold 1214
#define RTH 1893
#define PositionHold 1485  //Loiter mode
#define Auto 1661
#define FailSafe 980
////////////////////////////////////////////////
...
float Kd_rateRoll = 0.075;//0.15 0.085 0.025 - 0.045

float Kp_ratePitch = 2.42;//2.42 1.18 5.28
float Ki_ratePitch = 1.12;//1.12 2.75 0.5 - 2.8
float Kd_ratePitch = 0.075;//0.15 0.078 0.025 - 0.045
...
//GPS //สตาร์ท//////////////////////////////////////
float GPS_LAT_HOME = 13.868180;//13.868180,100.496297
float GPS_LON_HOME = 100.496297;
//ลงจอด
float waypoint1_LAT = 13.868544;//13.868544, 100.496433
float waypoint1_LON = 100.496433;//B,
//
...
int M_X_MAX = 410;     //310 185   209    170
int M_Y_MIN = -380;    //-369 -319  -311   -310
int M_Y_MAX = 360;     //397 513   563    546
int M_Z_MIN = -368;    //-392 -363  -374   -377
int M_Z_MAX = 320;     //346 386   429    502
////////////////////////////////////////////////////////////////////
//Observer hz
