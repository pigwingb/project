...
{
 u_z = ((motor_FRONTL + motor_FRONTR) - 2000.0f)*0.00630057f - 8.81f;//1557us = 1.16kg  uz - g ,,unit N *0.001691) - 9.81
...
///Y/////////////////////////////////////////////////////////////////////////////////
      ...
      double er_xt = (GPS_degree[0]*1e-7 - GPS_LAT_HOME)*cm_per_deg_lat - x1_xt;//R = 6,367,449 m; // Radius of earth in KM = 109397.6142 xx
      float er_vt = _velocity_north - x2_vt;//cm/s
      float er_at = accrX_Earth*100.0f - x3_at;//cm/s^2
      double ey_xt = (GPS_degree[1]*1e-7 - GPS_LON_HOME)*cm_per_deg_lon - y1_xt;//R = 6,367,449 m; // Radius of earth in KM = 109397.6142 xx
      float ey_vt = _velocity_east - y2_vt;//cm/s
      ...
      x1_hat = GPS_LAT_HOME + (vx1_hat/cm_per_deg_lat);
//Y/////////////////////////////////////////////////////////////////////////////
      ...
      y1_hat = GPS_LON_HOME + (vy1_hat/cm_per_deg_lon);
...
///////////////////////////////////////////////////////////////////
//Updated (a posteriori) state estimate //Update estimate with measurement zk
float ee1 = (Altitude_barof - z1_hat2);
