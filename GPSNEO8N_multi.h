...
int32_t GPS_coordLAT = 138681800;
int32_t GPS_coordLON = 1004962970;
...
void GPS_multiInt()
{
 ...
 // (which depends on the NMEA or MTK_BINARYxx settings)
  delay(200);
  Serial.print("$PUBX,41,1,0003,0001,38400,0*26\r\n");
  ...
  bool UBLOX_parse_gps(void) {
    ...
    case MSG_POSLLH:
      ...
      if(_fix_ok) {
        ...
        GPS_altitude   = _buffer.posllh.altitude_msl / 1000.0;      //alt in m
      }
      GPS_FIX = _fix_ok;
